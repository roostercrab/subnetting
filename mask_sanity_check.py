...
def check_mask(mask):
    ...
    mask_array = [int(i) for i in mask.split('.')]
    ...
    for octet in mask_array:
        ...
        elif (mo1 in interesting_octet_values) and (mo2 and mo3 and mo4 == 0): 
            return True
        elif (mo1 == 255) and (mo2 in interesting_octet_values and mo3 and mo4 == 0): 
            return True
        elif (mo1 and mo2 == 255) and (mo3 in interesting_octet_values and mo4 == 0): 
            return True
        elif (mo1 and mo2 and mo3 == 255) and (mo4 in interesting_octet_values):
            return True
        elif (mo1 == 255) and (mo2 and mo3 and mo4 == 0):
            return True
        elif (mo1 and mo2 == 255) and (mo3 and mo4 == 0):
            return True
        elif (mo1 and mo2 and mo3 == 255) and (mo4 == 0):
            return True
        elif (mo1 and mo2 and mo3 and mo4 == 255):
